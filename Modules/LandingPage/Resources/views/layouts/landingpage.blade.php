@php
    ...
    $admin_payment_setting = \App\Models\Utility::payment_settings();
        ...
        <body class="theme-2">
                        ...
                        <div class="row justify-content-center">
                            ...
                            @foreach ($collection as $key => $value)
                                <div class="col-xxl-3 col-lg-4 col-md-6">
                                    <div
                                        class="card price-card shadow-none  {{ $key == 2 ? 'bg-dark' : '' }}">
                                        <div class="card-body">
            ...
            <footer class="site-footer bg-gray-100">
                ...
                Copyright © 2022 | Design By ERPGo
                    ...
                    <p class="mb-0"> &copy;
                        {{ date('Y') }}
                        {{ App\Models\Utility::getValByName('footer_text') ? App\Models\Utility::getValByName('footer_text') : config('app.name', 'Salesy Saas') }}</p>
