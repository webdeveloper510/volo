    ...
    <div class="btn-group" role="group">
        @if (!empty($previous))
            <div class="action-btn  ms-2">
                <a href="{{ route('account.edit', $previous) }}" class="btn btn-sm btn-primary btn-icon m-1"
        ...
        @if (!empty($next))
            <div class="action-btn ms-2">
                <a href="{{ route('account.edit', $next) }}" class="btn btn-sm btn-primary btn-icon m-1"
            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('user', $user, $account->user_id, ['class' => 'form-control ']) !!}
                                            @error('user')
                    ...
                    <div id="useradd-2" class="card">
                        {{ Form::open(['route' => ['streamstore', ['account', $account->name, $account->id]], 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
                        <div class="card-header">
                            <h5>{{ __('Stream') }}</h5>
                                                ...
                                                <ul class="list-group team-msg">
                                                    <li class="list-group-item border-0 d-flex align-items-start mb-2">
                                                        <div class="avatar me-3">
                                                            ...
                                                            @endphp
                                                            <a href="{{ !empty($stream->file_upload) ? $profile . $stream->file_upload : $profile . 'avatar.png' }}"
                                                                target="_blank">
                                                                <img alt="" class="rounded-circle"
                                                                    @if (!empty($stream->file_upload)) src="{{ !empty($stream->file_upload) ? $profile . $stream->file_upload : $profile . 'avatar.png' }}" @else  avatar="{{ $remark->user_name }}" @endif>
                                                            </a>
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="text-end">
                                        <a href="#" data-size="lg"
                                            data-url="{{ route('contact.create', ['account', $account->id]) }}"
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="text-end">
                                        <a href="#" data-size="lg"
                                            data-url="{{ route('opportunities.create', ['account', $account->id]) }}"
                                            data-ajax-popup="true" data-bs-toggle="tooltip" title="{{ __('Create') }}"
                                                        ...
                                                        @can('Edit Opportunities')
                                                            <div class="action-btn bg-info ms-2">
                                                                <a href="{{ route('opportunities.edit', $opportunities->id) }}"
                                                                    ...
                                                                    class="mx-3 btn btn-sm d-inline-flex align-items-center text-white"
                                                                    data-title="{{ __('Opportunities Edit') }}"title="{{ __(' Details') }}"><i
                                                                        class="ti ti-edit"></i></a>
                                                            </div>
                                                        @endcan
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="text-end">
                                        <a href="#" data-size="lg"
                                            data-url="{{ route('commoncases.create', ['account', $account->id]) }}"
                                            data-ajax-popup="true" data-bs-toggle="tooltip" title="{{ __('Create') }}"
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="text-end">
                                        <a href="#" data-size="lg"
                                            data-url="{{ route('document.create', ['account', $account->id]) }}"
                                            data-ajax-popup="true" data-bs-toggle="tooltip" title="{{ __('Create') }}"
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="text-end">
                                        <a href="#" data-size="lg"
                                            data-url="{{ route('quote.create', ['account', $account->id]) }}"
                                            data-ajax-popup="true" data-bs-toggle="tooltip"
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="text-end">
                                        <a href="#" data-size="lg"
                                            data-url="{{ route('salesorder.create', ['account', $account->id]) }}"
                                            data-ajax-popup="true" data-bs-toggle="tooltip"
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="text-end">
                                        <a href="#" data-size="lg"
                                            data-url="{{ route('invoice.create', ['account', $account->id]) }}"
                                            data-ajax-popup="true" data-bs-toggle="tooltip"
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="text-end">
                                        <a href="#" data-size="lg"
                                            data-url="{{ route('call.create', ['call', 0]) }}" data-ajax-popup="true"
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="text-end">
                                        <a href="#" data-size="lg"
                                            data-url="{{ route('meeting.create', ['meeting', 0]) }}"
                                            data-ajax-popup="true" data-bs-toggle="tooltip"
