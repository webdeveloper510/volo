        ...
        <div class="invoice-header">
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td >
                            <h3 style=" display: block; text-transform: uppercase; font-size: 30px; font-weight: bold; padding: 15px; background: {{ $color }};color:{{ $font_color }}">QUOTE</h3>
                        ...
                        <td class="text-right">
                            <img class="invoice-logo"  src="https://demo.rajodiya.com/erpgo-saas/storage/proposal_logo/2_proposal_logo.png"
                                alt="">
