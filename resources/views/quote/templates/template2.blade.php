        ...
        <div class="invoice-header">
            ...
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td>
                            <h3 style="text-transform: uppercase; font-size: 25px; font-weight: bold; margin-bottom: 15px;">QUOTE</h3>
                            <table class="no-space">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Issue Date:</td>
                                        <td class="text-right">{{\App\Models\Utility::dateFormat($settings,$quote->issue_date)}}</td>
                                    </tr>
                                    <tr>
                                        <td>Due Date:</td>
                                        <td class="text-right">{{\App\Models\Utility::dateFormat($settings,$quote->due_date)}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
