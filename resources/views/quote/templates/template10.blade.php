        ...
        <div class="invoice-header">
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td >
                            <h3 style=" display: inline-block; text-transform: uppercase; font-size: 40px; font-weight: bold; border-top: 5px solid {{$color}}; padding-top: 15px;">QUOTE</h3>
                        ...
                        <td class="text-right">
                            <img data-v-b8f60a0c="" style="max-width: 250px;" class="d-logo" src="{{$img}}">
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        <td style="color:{{$color}};"><b>Number:</b> </td>
                                        <td class="text-right">{{\App\Models\Utility::quoteNumberFormat($settings,$quote->quote)}}</td>
                                    </tr>
                                    <tr>
                                        <td style="color:{{$color}};"><b>Issue Date:</b></td>
