    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 mt-4">
                <div class="img-section">
                    <img class="logo-img center-new" src="{{ url('storage/uploads/logo/volo.png')}}" style="width: 230;margin:0 200px">
                </div>
            </div>
        </div>
        <!-- NDA code start here -->
        <div class="row">
            <div class="col-sm-12 mt-4">
                ...
                <p>THIS AGREEMENT (the "Agreement”) is entered into on this <b>{{ $nda->aggrement_day }}</b> day of <b>{{ $nda->aggrement_by }}</b> by and
                    between VoloFleet, LLC & VoloFleet Logistics Holdings Corporation, (the” Disclosing Party”), and <b>{{ $nda->aggrement_receiving_party }}</b> (the “Receiving Party”).

                    The Receiving Party hereto desires to participate in discussions regarding <b>{{ $nda->aggrement_transaction }}</b> (the “Transaction”). During these discussions, Disclosing Party may share certain proprietary information with the Receiving Party. Therefore, in consideration of the mutual promises and covenants contained in this Agreement, and other good and valuable consideration, the receipt and sufficiency of which is hereby acknowledged, the parties hereto agree as follows:</p>
        ...
        <label for="signature"><b>{{__('Signature')}}:</b> </label>
        <div class="col-sm-12 border-new">
            <h5 class="input-new">
                <img src="{{__($nda->image)}}" alt="" srcset="">
            </h5>
        </div>
        ...
        <div class="positioned-container">
            <div class="disclosing-party">
                ...
                <span>By: </span>{{ $nda->disclosing_by }}<br>
                <span>Name: </span>{{ $nda->disclosing_name }}<br>
                <span>Title: </span>{{ $nda->disclosing_title }}<br>
            </div>
            <div class="receiving-party">
                <h4>Receiving Party</h4>
                <span>By: </span>{{ $nda->receiving_by }}<br>
                <span>Name: </span>{{ $nda->receiving_name }}<br>
                <span>Title: </span>{{ $nda->receiving_title }}
            </div>
        </div>
        <!-- NDA code end here -->
    </div>
