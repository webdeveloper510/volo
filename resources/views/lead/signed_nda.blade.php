    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 mt-4">
                ...
                THIS AGREEMENT (the "Agreement”) is entered into on this {{ $nda->aggrement_day }} day of {{ $nda->aggrement_by }} by and
                between VoloFleet, LLC & VoloFleet Logistics Holdings Corporation, (the” Disclosing Party”), and {{ $nda->aggrement_receiving_party }} (the “Receiving Party”).

                The Receiving Party hereto desires to participate in discussions regarding {{ $nda->aggrement_transaction }} (the “Transaction”). During these discussions, Disclosing Party may share certain proprietary information with the Receiving Party. Therefore, in consideration of the mutual promises and covenants contained in this Agreement, and other good and valuable consideration, the receipt and sufficiency of which is hereby acknowledged, the parties hereto agree as follows:
