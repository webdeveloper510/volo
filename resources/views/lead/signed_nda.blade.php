...
<body>
    <div class="container">
        ...
        THIS AGREEMENT (the "Agreement”) is entered into on this {{ $data['aggrement_day'] }} day of {{ $data['aggrement_by'] }} by and
        between VoloFleet, LLC & VoloFleet Logistics Holdings Corporation, (the” Disclosing Party”), and {{ $data['aggrement_receiving_party'] }} (the “Receiving Party”).

        The Receiving Party hereto desires to participate in discussions regarding {{ $data['aggrement_transaction'] }} (the “Transaction”). During these discussions, Disclosing Party may share certain proprietary information with the Receiving Party. Therefore, in consideration of the mutual promises and covenants contained in this Agreement, and other good and valuable consideration, the receipt and sufficiency of which is hereby acknowledged, the parties hereto agree as follows:
        ...
        <div class="row">
            <div class="col-6">
                ...
                <span>By </span>{{ $data['disclosing_by'] }} <br>
                <span>Name </span> {{ $data['disclosing_name'] }}<br>
                <span>Title </span> {{ $data['disclosing_title'] }}<br>
            </div>

            <div class="col-6">
                <h4>Receiving Party</h4>
                <span>By </span> {{ $data['receiving_by'] }}<br>
                <span>Name </span> {{ $data['receiving_name'] }}<br>
                <span>Title </span> {{ $data['receiving_title'] }}
            </div>
        </div>
        <!-- NDA code end here -->
    </div>
