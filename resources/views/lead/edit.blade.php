...
<div class="page-header-title">
    {{ __('Edit Opportunities') }} {{ '(' . $lead->opportunity_name . ')' }}
</div>
@endsection
@section('breadcrumb')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 need_full">
                                            <div class="form-group intl-tel-input">
                                                ...
                                                <div class="intl-tel-input">
                                                    <input type="tel" name="secondary_phone_number" class="phone-input form-control" placeholder="Enter Phone Number" maxlength="16" value="{{ $lead->secondary_contact }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6 need_full">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 need_full">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="value_of_opportunity" name="value_of_opportunity" value="{{ number_format((float) $lead->value_of_opportunity, 0, '.', ',') }}" placeholder="Enter Value of Opportunity" class="form-control" onkeyup="formatCurrency(this)">
                                            </div>
                                        </div>
                                        <div class="col-6 need_full">
                                            <div class="form-group">
