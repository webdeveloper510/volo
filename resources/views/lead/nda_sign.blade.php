...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-success" data-toggle="tooltip" onclick="getDataUrlAndCopy(this)" data-url="{{route('lead.signednda',urlencode(encrypt($lead->id)))}}" title='Copy To Clipboard'>
