                    ...
                    <div class="col-sm-12">
                        <div id="useradd-1" class="card">
                            ...
                            <div class="card-body ">
                                ...
                                <div class="col-6 need_full">
                                    <div class="form-group">
                                        <input type="checkbox" id="hardware-one-time" name="products[]" value="Hardware – One Time" {{ in_array('Hardware – One Time', json_decode($lead->products)) ? 'checked' : '' }} onchange="showAdditionalProductCategoryFields()">
                                        <label for="hardware-one-time">Hardware – One Time</label><br>

                                        <input type="checkbox" id="hardware-maintenance" name="products[]" value="Hardware – Maintenance Contracts" {{ in_array('Hardware – Maintenance Contracts', json_decode($lead->products)) ? 'checked' : '' }} onchange="showAdditionalProductCategoryFields()">
                                        <label for="hardware-maintenance">Hardware – Maintenance Contracts</label><br>

                                        <input type="checkbox" id="software-recurring" name="products[]" value="Software – Recurring" {{ in_array('Software – Recurring', json_decode($lead->products)) ? 'checked' : '' }} onchange="showAdditionalProductCategoryFields()">
                                        <label for="software-recurring">Software – Recurring</label><br>

                                        <input type="checkbox" id="software-one-time" name="products[]" value="Software – One Time" {{ in_array('Software – One Time', json_decode($lead->products)) ? 'checked' : '' }} onchange="showAdditionalProductCategoryFields()">
                                        <label for="software-one-time">Software – One Time</label><br>

                                        <input type="checkbox" id="systems-integrations" name="products[]" value="Systems Integrations" {{ in_array('Systems Integrations', json_decode($lead->products)) ? 'checked' : '' }} onchange="showAdditionalProductCategoryFields()">
                                        <label for="systems-integrations">Systems Integrations</label><br>

                                        <input type="checkbox" id="subscriptions" name="products[]" value="Subscriptions" {{ in_array('Subscriptions', json_decode($lead->products)) ? 'checked' : '' }} onchange="showAdditionalProductCategoryFields()">
                                        <label for="subscriptions">Subscriptions</label><br>

                                        <input type="checkbox" id="tech-deployment" name="products[]" value="Tech Deployment – Volume based" {{ in_array('Tech Deployment – Volume based', json_decode($lead->products)) ? 'checked' : '' }} onchange="showAdditionalProductCategoryFields()">
