                    ...
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            @if (isset($admin_payment_setting['is_bank_enabled']) && $admin_payment_setting['is_bank_enabled'] == 'on')
                                <a href="#useradd-15"
                                    class="list-group-item list-group-item-action border-0">{{ __('Bank Transfer') }} <div
                                        class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                            @endif
                ...
                <div class="col-xl-9">
                    @if ($admin_payment_setting['is_manually_enabled'] == 'on')
                        <div id="useradd-14" class="card">
                            ...
                            <div class="card-body">
                                <label>Requesting manual payment for the planned amount for the subscriptions paln.</label>
                            </div>
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="stripe_coupon" name="coupon"
                                                        class="form-control coupon"
                                                        placeholder="{{ __('Enter Coupon Code') }}" data-from="stripe">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="float-end">
                                                        ...
                                                        <button class="btn btn-primary d-flex align-items-center"
                                                            ...
                                                            {{ __('Pay Now') }}
                                                            (<span
                                                                class="paytab-final-price">{{ env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$' }}{{ $plan->price }}</span>)
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="float-end">
                                                        ...
                                                        <button class="btn btn-primary d-flex align-items-center"
                                                            ...
                                                            {{ __('Pay Now') }}
                                                            (<span
                                                                class="benefit-final-price">{{ env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$' }}{{ $plan->price }}</span>)
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-2 coupon-apply-btn">
                                                <div class="form-group apply-cashfree-btn-coupon">
                                                    <a href="#"
                                                        class="btn btn-primary align-items-center apply-coupon"
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-2 coupon-apply-btn">
                                                <div class="form-group apply-aamarpay-btn-coupon">
                                                    <a href="#"
                                                        class="btn btn-primary align-items-center apply-coupon"
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-2 coupon-apply-btn">
                                                <div class="form-group apply-paytr-btn-coupon">
                                                    <a href="#"
                                                        class="btn btn-primary align-items-center apply-coupon"
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-2 coupon-apply-btn">
                                                <div class="form-group apply-yookassa-btn-coupon">
                                                    <a href="#"
                                                        class="btn btn-primary align-items-center apply-coupon"
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-2 coupon-apply-btn">
                                                <div class="form-group apply-midtrans-btn-coupon">
                                                    <a href="#"
                                                        class="btn btn-primary align-items-center apply-coupon"
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-2 coupon-apply-btn">
                                            <div class="form-group apply-xendit-btn-coupon">
                                                <a href="#"
                                                    class="btn btn-primary align-items-center apply-coupon"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center"
                                                        ...
                                                        {{ __('Pay Now') }}
                                                        (<span
                                                            class="payhere-final-price">{{ env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$' }}{{ $plan->price }}</span>)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
