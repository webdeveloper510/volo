...
<body>
    <div class="invoice-preview-main" style="border-right:40px solid {{$color}};">
        <div class="invoice-header">
            <table>
                <tbody>
                    <tr>
                        <td >
                            <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold; color: {{$color}}; margin-bottom: 10px;">SALES ORDER</h3>
