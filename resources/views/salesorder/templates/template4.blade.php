        ...
        <div class="invoice-header">
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td >
                            <h3 style="text-transform: uppercase; font-size: 30px; font-weight: bold; margin-bottom: 10px;">SALES ORDER</h3>
                            ...
                            <img data-v-363339a0="" src="{{$img}}" style="max-width: 250px" class="d-logo">
                                ...
                                <table class="no-space">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Number: </td>
                                            <td class="text-right">{{\App\Models\Utility::salesorderNumberFormat($settings,$salesorder->Iinvoice)}}</td>
                                        </tr>
                                        <tr>
                                            <td>Issue Date:</td>
