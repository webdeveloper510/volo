            ...
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td>
                            <h3
                                style=" display: inline-block; text-transform: uppercase; font-size: 40px; font-weight: bold; border-top: 5px solid {{ $color }}; padding-top: 15px;">
                                SALES ORDER</h3>
                            ...
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            {{ \App\Models\Utility::invoiceNumberFormat($settings, $salesorder->invoice) }}
                                        </td>
                                    </tr>
                                    <tr>
