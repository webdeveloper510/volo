...
<script>
    $(document).ready(function() {
        ...
        $('.additional-product-category').on('click', '.clone-btn', function(event) {
            ...
            // Update IDs and names of cloned input fields
            clone.find('input, select').each(function() {
                var oldId = $(this).attr('id');
                var oldName = $(this).attr('name');
                var newId = oldId + '_' + counter;
                var newName = oldName + '_' + counter;
                $(this).attr('id', newId);
...
<script>
    function onUnitChange(event) {
        ...
        var nextSibling = selectElement.parentElement.nextElementSibling;
        if (nextSibling && nextSibling.classList.contains('extra-input')) {
            nextSibling.remove();
        }
        ...
        if (selectedValue === 'other') {
            ...
            // Append the input box after the select element
            selectElement.parentElement.parentElement.appendChild(inputBox);
        }
    }

    document.addEventListener("DOMContentLoaded", function() {
        // Attach the onchange function to all select elements with class "form-control"
        var selectElements = document.querySelectorAll('.form-control');
        selectElements.forEach(function(selectElement) {
            selectElement.addEventListener('change', onUnitChange);
        });
    });
</script>
