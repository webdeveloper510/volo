                                ...
                                <div class="accordion accordion-flush setting setting-accordion1" id="accordionExample">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row mt-3">
                                                                ...
                                                                <div class="d-flex align-items-center mb-2">
                                                                    <div class="col-3">
                                                                        <label class="form-label me-2" style="font-weight: 600;">Code</label>
                                                                    </div>
                                                                    <div class="col-3" style="margin-left: 10px;">
                                                                        <label class="form-label me-2" style="font-weight: 600;">Symbol</label>
                                                                    </div>
                                                                    <div class="col-3" style="margin-left: 10px;">
                                                                        <label class="form-label me-2" style="font-weight: 600;">Conversion Rate (to USD)</label>
                                                                    </div>
                                                                    <div class="col-3"></div>
                                                                </div>
                                    ...
                                    <div id="power-bi" class="accordion-item  card">
                                        ...
                                        <div id="collapse222" class="accordion-collapse collapse" aria-labelledby="heading-2-15" data-bs-parent="#accordionExample">
                                            <div class="accordion-body1">
                                                <div class="table-responsive overflow_hidden">
                                                    <table id="powerBidatatable" class="table align-items-center datatable">
                                                        <thead class="thead-light">
                                                            <tr>
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var modal = new bootstrap.Modal(document.getElementById('powerBiModal'));

            document.querySelector('.powerbi-action-btn a').addEventListener('click', function(event) {
                modal.show();
            });

            document.getElementById('powerBiModal').addEventListener('hidden.bs.modal', function() {
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.clone-btn').on('click', function() {
                var $clone = $('.currency-field:first').clone();
                $clone.find('input').val('');
                $clone.find('.delete-btn').remove();
                addDeleteButton($clone);

                $('#currency-fields-container').append($clone);
                $('#currency-fields-container').scrollTop($('#currency-fields-container')[0].scrollHeight);
            });
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crmcentraverse/public_html/volo/resources/views/settings/index.blade.php ENDPATH**/ ?>