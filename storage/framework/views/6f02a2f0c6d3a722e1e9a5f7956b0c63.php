...
<div class="row">
    ...
    <div class="col-6 need_full">
        <div class="form-group">
            ...
            <input type="hidden" name="update_optgroup" id="update_optgroup" value="">
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        $('#update').change(function() {
            var optgroupLabel = $('option:selected', this).parent().attr('label');

            $('#update_optgroup').val(optgroupLabel);
        });
    });
</script><?php /**PATH C:\xampp\htdocs\volo\resources\views/objective_tracker/create.blade.php ENDPATH**/ ?>