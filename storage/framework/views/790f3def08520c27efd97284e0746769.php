        ...
        <div class="tab-content">
            <div id="barmenu0" class="tab-pane fade in active show mt-5">
                ...
                <div class="row">
                    ...
                    <div class="col-6 need_full">
                        <div class="form-group">
                            <?php echo e(Form::label('entity_name',__('Entity Name'),['class'=>'form-label'])); ?>

                            <span class="text-sm">
                                <i class="fa fa-asterisk text-danger" aria-hidden="true"></i>
                            </span>
                            <?php echo e(Form::text('entity_name',null,array('class'=>'form-control','placeholder'=>__('Enter Entity Name'),'required'=>'required'))); ?>
