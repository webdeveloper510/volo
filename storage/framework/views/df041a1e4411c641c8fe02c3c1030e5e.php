                        ...
                        <div class="mobile collapse navbar-collapse" id="navbarCollapse">
                            <div class="navbar-nav">
                                <ul class="dash-navbar">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Calendar')): ?>
...
</script><?php /**PATH /home/crmcentraverse/public_html/volo/resources/views/partials/admin/header.blade.php ENDPATH**/ ?>