                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 need_full">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="value_of_opportunity" name="value_of_opportunity" value="<?php echo e(number_format((float) $lead->value_of_opportunity, 0, '.', ',')); ?>" placeholder="Enter Value of Opportunity" class="form-control" onkeyup="formatCurrency(this)">
                                            </div>
                                        </div>
                                        <div class="col-6 need_full">
                                            <div class="form-group">
