    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 mt-4">
                ...
                <p>THIS AGREEMENT (the "Agreement”) is entered into on this <b><?php echo e($nda->aggrement_day); ?></b> day of <b><?php echo e($nda->aggrement_by); ?></b> by and
                    between VoloFleet, LLC & VoloFleet Logistics Holdings Corporation, (the” Disclosing Party”), and <b><?php echo e($nda->aggrement_receiving_party); ?></b> (the “Receiving Party”).

                    The Receiving Party hereto desires to participate in discussions regarding <b><?php echo e($nda->aggrement_transaction); ?></b> (the “Transaction”). During these discussions, Disclosing Party may share certain proprietary information with the Receiving Party. Therefore, in consideration of the mutual promises and covenants contained in this Agreement, and other good and valuable consideration, the receipt and sufficiency of which is hereby acknowledged, the parties hereto agree as follows:</p>
        ...
        <label for="signature"><b><?php echo e(__('Signature')); ?>:</b> </label>
