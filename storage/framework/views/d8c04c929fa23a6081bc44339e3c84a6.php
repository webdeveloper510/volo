...
<a href="#" data-url="<?php echo e(route('lead.create',['lead',0])); ?>" data-size="lg" data-ajax-popup="true" data-bs-toggle="tooltip" data-title="<?php echo e(__('Create New Opportunities')); ?>" title="<?php echo e(__('Create')); ?>" class="btn btn-sm btn-primary btn-icon m-1">
                                    ...
                                    <table class="table datatable" id="datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="sort" data-sort="name"><?php echo e(__('Company')); ?> <span class="opticy"></span></th>
