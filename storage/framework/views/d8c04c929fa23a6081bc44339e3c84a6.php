...
<a href="#" data-url="<?php echo e(route('lead.create',['lead',0])); ?>" data-size="lg" data-ajax-popup="true" data-bs-toggle="tooltip" data-title="<?php echo e(__('Create New Opportunitie')); ?>" title="<?php echo e(__('Create')); ?>" class="btn btn-sm btn-primary btn-icon m-1">
                                    ...
                                    <table class="table datatable" id="datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="text-end"><?php echo e(__('Action')); ?> <span class="opticy"></span></th>
                                                <?php endif; ?>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="javascript:void(0);" data-size="md" data-url="<?php echo e(route('lead.ndasign',urlencode(encrypt($lead->id)))); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" data-title="<?php echo e(__('NDA')); ?>" title="<?php echo e(__('Sign NDA')); ?>" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white ">
