                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table datatable" id="datatable">
                                        ...
                                        <tbody>
                                            ...
                                            if ($lead->user_id == 0) {
                                            $importUser = \App\Models\UserImport::where('lead_id', $lead->id)->first(['company_name']);
                                            } else {
                                            $importUser = \App\Models\UserImport::where('id', $lead->user_id)->first(['company_name']);
                                            }

                                            // If an import user is found, set the company_name
                                            if ($importUser) {
                                            $company_name = $importUser->company_name;
                                            }
                                            ?>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <?php echo e(ucfirst($company_name)); ?>
