...
<div class="row">
    ...
    <div class="col-6 need_full" id="client_select">
        <div class="form-group">
            <?php echo e(Form::label('existing_client', __('Company Name'), ['class' => 'form-label'])); ?>
    ...
    <div class="col-6 need_full">
        <div class="form-group">
            ...
            <select class="form-control" name='assign_staff' required>
                ...
                <option class="form-control" value="<?php echo e($staff->id); ?>"><?php echo e($staff->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
    </div>
    ...
    <div class="col-6 need_full">
        <div class="form-group">
            ...
            ?>
            <input type="checkbox" id="<?php echo e($id); ?>" name="products[]" value="<?php echo e($type); ?>" onchange="showAdditionalProductCategoryFields(this)">
...
<div class="modal-footer">
    ...
    <?php echo e(Form::submit(__('Save'),array('class'=>'btn btn-primary', 'id'=>'submit-button'))); ?>
...
</script><?php /**PATH /home/crmcentraverse/public_html/volo/resources/views/lead/create.blade.php ENDPATH**/ ?>