    ...
    <div class="card">
        <div class="list-group list-group-flush sidebar-nav nav-pills nav-stacked" id="menu">
            ...
            <div class="scrollbar">
                ...
                <?php if(\Request::route()->getName() == 'client.edit'): ?>
                <a href="#" class="list-group-item list-group-item-action active">
                    <span class="fa-stack fa-lg pull-left"><i class="ti ti-user" title="Edit Client"></i></span>
                    <span class="dash-mtext"><?php echo e(__('Edit Client')); ?> </span>
                </a>
                <?php endif; ?>
                ...
                <?php endif; ?>
                <?php if( \Request::route()->getName() == 'powerbi.report.show' || \Request::route()->getName() == 'powerbi.report.page' || \Request::route()->getName() == 'report.show' ||
