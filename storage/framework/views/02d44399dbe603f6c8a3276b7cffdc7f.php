                                    ...
                                    <table class="table datatable" id="datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php $__currentLoopData = $selected_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php echo e($product); ?>

                                                    <?php if(($index + 1) % 4 != 0 && $index + 1 != count($selected_products)): ?>
                                                    , <!-- Add a comma after each product except the last one in the row -->
                                                    <?php endif; ?>
                                                    <?php if(($index + 1) % 4 == 0): ?>
                                                    <br>
                                                    <?php endif; ?>
