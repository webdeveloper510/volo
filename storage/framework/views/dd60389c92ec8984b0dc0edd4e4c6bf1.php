    ...
    <div class="card">
        <div class="list-group list-group-flush sidebar-nav nav-pills nav-stacked" id="menu">
            ...
            <div class="scrollbar">
                ...
                <?php endif; ?>
                <?php if( \Request::route()->getName() == 'powerbi.report.show' || \Request::route()->getName() == 'report.index' || \Request::route()->getName() == 'report.show' ||
...
</script><?php /**PATH /home/crmcentraverse/public_html/volo/resources/views/partials/admin/sidebar.blade.php ENDPATH**/ ?>