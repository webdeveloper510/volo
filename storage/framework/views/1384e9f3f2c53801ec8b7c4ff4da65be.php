...
<body>
    <div class="container mt-5">
        <div class="row card">
            <div class="col-md-12">
                <form method="POST" action="<?php echo e(route('lead.ndaresponse',urlencode(encrypt($lead->id)))); ?>" id='formdata'>
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="proposal" value="<?= isset($_GET['prop']) ? $_GET['prop'] : '' ?>">
                    <div class="row">
                        <div class="col-sm-12 mt-4 border-new">
                            <div class="img-section">
                                <img class="logo-img center-new" src="<?php echo e(url('storage/uploads/logo/volo.png')); ?>" style="width: 230px;">
                            </div>
                        </div>

                        <!-- NDA code start here -->
                        <h3 class="mt-4" style="text-align: center;">NON-DISCLOSURE AGREEMENT</h3>
                        THIS AGREEMENT (the "Agreement”) is entered into on this <?php echo e(base64_decode(urldecode(request()->query('day')))); ?> day of <?php echo e(base64_decode(urldecode(request()->query('by')))); ?> by and
                        between VoloFleet, LLC & VoloFleet Logistics Holdings Corporation, (the” Disclosing Party”), and <?php echo e(base64_decode(urldecode(request()->query('rec_p')))); ?> (the “Receiving Party”).

                        The Receiving Party hereto desires to participate in discussions regarding <?php echo e(base64_decode(urldecode(request()->query('tran')))); ?> (the “Transaction”). During these discussions, Disclosing Party may share certain proprietary information with the Receiving Party. Therefore, in consideration of the mutual promises and covenants contained in this Agreement, and other good and valuable consideration, the receipt and sufficiency of which is hereby acknowledged, the parties hereto agree as follows:
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <p>By <input class="document-input" type="text" name="disclosing_by" value="<?php echo e(base64_decode(urldecode(request()->query('disc_b')))); ?>" readonly /></p>
                                <p>Name <input class="document-input" type="text" name="disclosing_name" value="<?php echo e(base64_decode(urldecode(request()->query('disc_p_n')))); ?>" readonly /></p>
                                <p>Title <input class="document-input" type="text" name="disclosing_title" value="<?php echo e(base64_decode(urldecode(request()->query('disc_p_t')))); ?>" readonly /></p>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-4 mb-3">
                            <input type="hidden" name="aggrement_day" value="<?php echo e(base64_decode(urldecode(request()->query('day')))); ?> ">
                            <input type="hidden" name="aggrement_by" value="<?php echo e(base64_decode(urldecode(request()->query('by')))); ?>">
                            <input type="hidden" name="aggrement_receiving_party" value="<?php echo e(base64_decode(urldecode(request()->query('rec_p')))); ?>">
                            <input type="hidden" name="aggrement_transaction" value="<?php echo e(base64_decode(urldecode(request()->query('tran')))); ?>">
...
</script><?php /**PATH C:\xampp\htdocs\volo\resources\views/lead/nda.blade.php ENDPATH**/ ?>