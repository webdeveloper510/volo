...
<!-- <?php if(\Auth::user()->type == 'owner' || \Auth::user()->type == 'snr manager' || \Auth::user()->type == 'admin' && \Auth::user()->type != 'Accountant' && \Auth::user()->type != 'Manager'): ?> -->
<?php if($userRoleType == 'company'): ?>
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create E-Sign')): ?>
<a href="<?php echo e(route('contracts.create')); ?>" class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Create New E-Sign')); ?>"><i class="ti ti-plus text-white"></i></a>
<?php endif; ?>
<?php endif; ?>
<!-- <?php endif; ?> -->
<?php $__env->stopSection(); ?>
