                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="name"><?php echo e(__('Time')); ?> <span class="opticy">
                                        dddd</span></th>
                                <th scope="col" class="sort" data-sort="name"><?php echo e(__('Assigned Team Member')); ?> <span
                                        class="opticy"> dddd</span></th>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crmcentraverse/public_html/volo/resources/views/report/leadsanalytic.blade.php ENDPATH**/ ?>